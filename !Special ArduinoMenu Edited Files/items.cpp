...
// The following 2 lines were added by JMC on 5/16/2021 to support selection
// of edit cursor by the application.
const char *fieldBase::TunningCursor = ">";
const char *fieldBase::NonTunningCursor = ":";
...
Used fieldBase::printTo(navRoot &root,bool sel,menuOut& out, idx_t idx,idx_t len,idx_t panelNr) {
  ...
  if (l<len) {
    ...
    // The following line was modified by JMC on 5/16/2021 to support selection
    // of edit cursor by the application.
